...
module.exports.handleEvent = async ({
	...
	["bot mc", "Mc bot", "tui to magi", "guya", "Bot teri maa ki chut", "hol amar", "ভোদার বট", "stupid bots", "চাপড়ি বট", "Bot lund", "kakashi mc", "Mc", "toru kharap", "fuck bots", "hol pagol", "tore xhudi", "useless bot", "বট চুদি", "fuck you", "bc bot", "Nikal bsdk bot", "shawya", "হেড়ার বট", "bot paylac rồi", "hol amr", "amar hol", "nigga", "tuk cudi", "shawyar bot", "bot óc", "bot óc chó", "magi", "bot tiki", "hol er bot", "lol bot", "chat er khotha", "lồn bot", "boder bot", "chat pagol", "bot cac", "maria abar k", "bot xhudi", "bot sudi", "🖕🖕🖕", "amr hol de", "bot fake", "Bot code", "khanki magi", "bad bots", "bot cau"].forEach((a => {
